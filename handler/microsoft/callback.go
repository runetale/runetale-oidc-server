...
type MicrosoftCallbackHandler struct {
	provider.Provider
	*database.Postgres
...
func NewCallbackHandler(
	...
	return &MicrosoftCallbackHandler{p, db, trepo, urepo, serverClient, crypto.NewJwtIssuer(jwtSecret, jwtAud, jwtIss), webRedirectLoginURL}, nil
}

func (g *MicrosoftCallbackHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	tx, err := g.Begin()
	if err != nil {
